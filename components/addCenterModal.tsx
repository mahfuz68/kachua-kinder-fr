...
export default function AddCenterModal({ prop }: Props) {
  ...
  const crateUser = async (
    ...
    try {
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/examcenter/`,
        {
          method: "POST",
          body: JSON.stringify({
            name: name,
            address: mobile,
            totalSeat: Number(convertToEngNumber(schoolName)),
            examId: prop.examId,
          }),
          headers: {
      ...
      if (data.error) {
        ...
        prop.setExamCenter([data, ...prop.examcenter]);
        ...
        <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
          ...
          <div className="flex justify-between items-center pb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
            <h3 className="text-lg ml-6 font-semibold text-gray-900 dark:text-white">
              পরীক্ষার কেন্দ্র অ্যাড করুন
            </h3>
            <button
              onClick={(e) => prop.setOpenModal(undefined)}
              type="button"
            ...
            <div className="mt-6 ml-6 flex gap-x-4 pb-4">
              <button
                ...
                onClick={() => {
                  ...
                  console.log(name, mobile, schoolName);

                  if (name && mobile && schoolName) {
                    console.log("fire onclick event 2");

                    crateUser(name, mobile, schoolName);
                  } else {
              ...
              >
                ...
                {loading ? (
                  ...
                  <p>
                    <span className="hidden">পরীক্ষার</span> কেন্দ্র অ্যাড করুন
                  </p>
                )}
              </button>
              <button
