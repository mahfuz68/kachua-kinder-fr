...
export default function DeleteSchoolModal({ prop }: { prop: any }) {
    ...
    try {
      ...
      if (data.error) {
        ...
        prop.setExamWiseSchool(
          prop?.data.filter((s: any) => s?.id !== data?.id)
        );
        clearState();
  ...
  return (
    <div
      ...
      aria-hidden="false"
      className={`${
        prop.openModal === String(prop?.school?.id) + "delete"
          ? "block"
          : "hidden"
          ...
          <div>
            ...
            <div className="p-6 text-center">
              ...
              <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                আপনি কি নিশ্চিত এই স্কুলটি ডিলিট করবেন?
              </h3>
